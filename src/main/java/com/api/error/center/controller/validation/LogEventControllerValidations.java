...
public abstract class LogEventControllerValidations {
    ...
    protected boolean validateFindAllByFiltersRequestParams(Long sourceId, User source, String startDateIn, String endDateIn, Response<Page<LogEventDtoToPageble>> response) {
    ...
    private boolean validateSourceExistenceFromRequestParam(Long sourceId, User source, Response<Page<LogEventDtoToPageble>> response) {
